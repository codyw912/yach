...
pub use crate::rig_adapter::{
    ...
    RigOpenAiCompatibleSmokeConfig, RigOpenAiCompatibleSmokeReport, run_anthropic_smoke,
    run_chatgpt_subscription_smoke, run_openai_compatible_http_smoke, run_openai_compatible_smoke,
};
