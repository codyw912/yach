...
mod tests {
    ...
    use super::{
        ...
        ExtensionToolHandler, ExtensionToolResultStatus, ExtensionToolRisk, FilesConfig,
        FixtureToolExecutor, JsonlSessionStore, MetricAttribute,
        ...
        apply_agent_edit_tool_review, assemble_project_static_context, backend_channels,
    ...
    impl ExtensionHostInvoker for RecordingExtensionHostInvoker {
        fn invoke(
            ...
            self.response
                .clone()
                .map(|content| ExtensionHostInvocation::ToolResult {
                    content,
