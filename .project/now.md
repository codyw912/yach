...
- Implement backend-only fixture provider tool-result continuation primitives/tests from `docs/plans/2026-05-05-004-plan-provider-tool-result-continuation.md`, only after approval; stop before real provider SDK continuation or native-provider integration.
