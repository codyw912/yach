...
- Stock Superpowers artifacts under `docs/project/specs/` and `docs/project/plans/` remain task-level workflow outputs. `docs/project/` should link the few currently relevant Superpowers specs or plans instead of replacing those paths.
