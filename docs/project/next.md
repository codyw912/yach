...
The first closely watched `full-access` dogfood pass exposed five usability
...
Resume owner dogfood and take the next naturally observed blocker. If the next
approval slice is selected, add scoped session grants, then project-keyed user
grants; `plan`, auto-review, and sandboxing remain separate work. Approval
design:
