...
This replaces `docs/project/plans/2026-05-10-native-session-resume-metrics-baseline.md` for execution. It incorporates the storage feedback that full-file JSONL rewrites are likely to fail before JSON parsing itself becomes a bottleneck.
