...
> Superseded for execution by `docs/project/plans/2026-05-10-native-session-store-resume-metrics.md`. The replacement keeps the same product goal but incorporates the append-only store seam and avoids legitimizing full-file JSONL rewrites as the runtime path.
...
This plan implements the first Native MVP slice from `docs/project/specs/2026-05-09-native-mvp-definition-design.md`: session log/resume plus metrics baseline.
...
```markdown
- `docs/project/specs/2026-05-09-native-mvp-definition-design.md`
- `docs/project/plans/2026-05-10-native-session-resume-metrics-baseline.md`
```
