...
This plan implements `docs/project/specs/2026-05-18-provider-read-search-content-design.md`.
...
**Files:**
- Modify: `docs/project/specs/2026-05-18-provider-read-search-content-design.md`
- Modify: `docs/project/state.md`
- Modify: `docs/project/next.md`

- [ ] **Step 1: Mark design accepted**

In `docs/project/specs/2026-05-18-provider-read-search-content-design.md`, change:
...
```bash
git add docs/project/specs/2026-05-18-provider-read-search-content-design.md docs/project/state.md docs/project/next.md
