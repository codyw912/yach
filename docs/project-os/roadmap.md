...
| M3 — compatibility beta | `in-progress` | `../../PRD-v0.1.md`, `../status/compatibility-evidence-2026-04-27.md`, `compatibility.md`, PR #8 | Evidence pass is complete and session/fork groundwork has landed: entry-id fork, fork-message parsing, recent session discovery/labels, and live fork/resume smokes. Next M3 planning should decide the resource path and design full session tree/branch-summary/compaction presentation plus canonical compatibility fixtures. |
...
The current committed focus has moved past verified M2 TUI alpha polish, the first broader compatibility evidence pass, and the first M3 session/fork groundwork PR. Active work remains performance evidence toward PRD SLOs via `../plans/2026-04-27-002-feat-performance-evidence-harness-plan.md`, while M3 compatibility planning should use `../status/compatibility-evidence-2026-04-27.md` plus PR #8's session evidence to choose the resource path and full session-tree design.
