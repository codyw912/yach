...
| P3 | Implement M2 alpha hardening pass | `planned` | `../plans/2026-04-26-002-feat-m2-tui-hardening-plan.md` | Implementation should follow the focused hardening plan rather than expanding scope opportunistically. | Highest-priority M2 hardening items are implemented and verified. | Current recommended next work. |
