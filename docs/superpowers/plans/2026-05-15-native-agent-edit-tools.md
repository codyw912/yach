...
This plan intentionally implements only the canonical exact/create edit surface from `docs/superpowers/specs/2026-05-15-native-agent-edit-tool-surface-design.md`.
