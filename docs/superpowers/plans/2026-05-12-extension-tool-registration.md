...
**Files:**
- Modify: `docs/superpowers/specs/2026-05-12-extension-tool-registration-design.md`
...
```bash
git add crates/yach-backend/src/extension.rs crates/yach-backend/src/lib.rs docs/superpowers/specs/2026-05-12-extension-tool-registration-design.md
